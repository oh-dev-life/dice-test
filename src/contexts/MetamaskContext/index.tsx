...
export const MetamaskContextProvider = createContext<WalletProviderContext>({
  wallets: {},
  selectedWallet: null,
...
export const MetamaskProvider = ({
  ...
  return (
    <MetamaskContextProvider.Provider value={contextValue}>
      {children}
    </MetamaskContextProvider.Provider>
  );
};
